...
model_lin_acc_hipp_mean <- lm(m_m_acc ~ hipp_mean_c, data = MRS_SCD_MCI)
summary(model_lin_acc_hipp_mean)
AIC(model_lin_acc_hipp_mean)
model_quad_acc_hipp_mean <- lm(m_m_acc ~ hipp_mean_c + hipp_mean_sq, data = MRS_SCD_MCI)
summary(model_quad_acc_hipp_mean)
AIC(model_quad_acc_hipp_mean)
...
summary(model_lin_prec_hipp_mean)
AIC(model_lin_prec_hipp_mean)
model_quad_prec_hipp_mean <- lm(m_m_precuneus ~ hipp_mean_c + hipp_mean_sq, data = MRS_SCD_MCI)
summary(model_quad_prec_hipp_mean)
AIC(model_quad_prec_hipp_mean)
...
summary(model_lin_acc_thick)
AIC(model_lin_acc_thick)
model_quad_acc_thick <- lm(m_m_acc ~ cortical_thickness_adsignature_dickson_c + cortical_thickness_adsignature_dickson_sq, data = MRS_SCD_MCI)
summary(model_quad_acc_thick)
AIC(model_quad_acc_thick)
...
summary(model_lin_prec_thick)
AIC(model_lin_prec_thick)
model_quad_prec_thick <- lm(m_m_precuneus ~ cortical_thickness_adsignature_dickson_c + cortical_thickness_adsignature_dickson_sq, data = MRS_SCD_MCI)
summary(model_quad_prec_thick)
AIC(model_quad_prec_thick)
...
model_quad_acc_sup_act_rev <- lm(m_m_acc_c ~ activation_parietal_sup_l + activation_parietal_sup_l_sq, data = MRS_SCD_MCI)
summary(model_quad_acc_sup_act_rev)
AIC(model_quad_acc_sup_act_rev)
...
model_lin_acc_memor <- lm(memoria_libre_correcte ~ m_m_acc_c, data = MRS_SCD_MCI)
summary(model_lin_acc_memor)
AIC(model_lin_acc_memor)
model_quad_acc_memor <- lm(memoria_libre_correcte ~ m_m_acc_c + m_m_acc_sq, data = MRS_SCD_MCI)
summary(model_quad_acc_memor)
AIC(model_quad_acc_memor)

# Model 10 memoria ~ Precuneus Glu
model_lin_prec_memor <- lm(memoria_libre_correcte ~ m_m_precuneus_c, data = MRS_SCD_MCI)
summary(model_lin_prec_memor)
AIC(model_lin_prec_memor)
model_quad_prec_memor <- lm(memoria_libre_correcte ~ m_m_precuneus_c + m_m_precuneus_sq, data = MRS_SCD_MCI)
summary(model_quad_prec_memor)
AIC(model_quad_prec_memor)

# Model 11 face name ~  ACC glu
model_lin_acc_memor <- lm(face_name_rappel_differe_spectro ~ m_m_acc_c, data = MRS_SCD_MCI)
summary(model_lin_acc_memor)
AIC(model_lin_acc_memor)
model_quad_acc_memor <- lm(face_name_rappel_differe_spectro ~ m_m_acc_c + m_m_acc_sq, data = MRS_SCD_MCI)
summary(model_quad_acc_memor)
AIC(model_quad_acc_memor)

# Model 12 face name ~ Precuneus glu
model_lin_prec_memor <- lm(face_name_rappel_differe_spectro ~ m_m_precuneus_c, data = MRS_SCD_MCI)
summary(model_lin_prec_memor)
AIC(model_lin_prec_memor)
model_quad_prec_memor <- lm(face_name_rappel_differe_spectro ~ m_m_precuneus_c + m_m_precuneus_sq, data = MRS_SCD_MCI)
summary(model_quad_prec_memor)
AIC(model_quad_prec_memor)
...
model_lin_prec_memor <- lm(associative_memory_performance ~ m_m_precuneus_c, data = MRS_SCD_MCI)
summary(model_lin_prec_memor)
AIC(model_lin_prec_memor)
model_quad_prec_memor <- lm(associative_memory_performance ~ m_m_precuneus_c + m_m_precuneus_sq, data = MRS_SCD_MCI)
summary(model_quad_prec_memor)
AIC(model_quad_prec_memor)
